...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'dissertative'
        db.create_table('account_dissertative', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('account', ['dissertative'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'dissertative'
        db.delete_table('account_dissertative')


    models = {
        'account.dissertative': {
            'Meta': {'object_name': 'dissertative'},
