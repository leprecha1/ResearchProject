...
urlpatterns = patterns('',
    ...
    url(r'research/[0-9]/delete$', 'account.views.research_delete', name='research_delete'),
    url(r'research/[0-9]$', 'account.views.research_answer', name='research_answer'),
    url(r'research/[0-9]/question/new$', 'account.views.new_question', name='new_answer'),
